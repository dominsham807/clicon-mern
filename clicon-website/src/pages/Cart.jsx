...
import { calculatePrice, decreaseQty, increaseQty, removeItem, updateCart } from '../redux/reducers/cartReducer.js'

import "../styles/cart.css"

const Cart = () => {
    const { cartItems, quantity, subtotal, totalPrice, discount, shippingCharge } = useSelector((state) => state.cartReducer)
                ...
                <div className="row">
                                        ...
                                        {cartItems.map((item, index) => {   
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <button className="close-btn" onClick={() => removeSingleItem(item)}>
                    ...
                    <div className="col-xxl-4">
                        <div className="shopping-cart-total-wrapper">
                            ...
                            <a className="btn btn-primary w-100 checkout-cart-btn" href='/checkout'>
                                Proceed to Checkout
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
